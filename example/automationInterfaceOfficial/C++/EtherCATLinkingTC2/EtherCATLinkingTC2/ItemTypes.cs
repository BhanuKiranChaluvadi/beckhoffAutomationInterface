...
namespace EtherCATLinkingTC2
{
    ...
    public enum TreeItemType
    {
        ...
        /// <summary>
        /// Plc Application (Root Plc Object)
        /// </summary>
        PlcApplication = 600,
        /// <summary>
        /// Plc Folder object
        ...
        /// </summary>
        PlcGlobalVariablesList = 615,
        /// <summary>
        /// Transient Object
        /// </summary>
        PlcTransientObject = 616,
        /// <summary>
        /// Library Manager
        /// </summary>
        PlcLibraryManager = 617,
        /// <summary>
        /// Interface
        /// </summary>
        PlcInterface = 618,
        ...
        /// Program Reference
        /// </summary>
        PlcProgramReference = 622,
        /// <summary>
        /// External Data Type (Defined in System Manager)
        /// </summary>
        PlcExternalDataType = 623,
        /// <summary>
        /// External Data Type Container
        /// </summary>
        PlcExternalDataTypeContainer = 624,
        /// <summary>
        /// Tmc Description File
        /// </summary>
        PlcTmcDescription = 625,
    ...
    public enum BoxType
    {
        ...
        /// <summary>
        /// EK1100 Ethernet Coupler (EtherCAT)(BOXTYPE_EXXXXX)
        /// </summary>
    ...
    /// <summary>
    /// Extension class for the <see cref="POULanguageType"/>
    /// </summary>
    public static class POULanguageTypeExtension
    {
        /// <summary>
        /// Converts the <see cref="POULanguageType"/> to an Int32
        /// </summary>
        /// <param name="type">The type.</param>
        /// <returns></returns>
        public static int AsInt32(this POULanguageType type)
        {
            return (int)type;
        }
    }
